    ...
    def _write_updater_script(self, target_exe, downloaded_exe, backup_exe, current_pid, updater_log_path):
        try:
            ...
            script_lines = [
                ...
                'powershell -NoProfile -NonInteractive -ExecutionPolicy Bypass -Command "try { Wait-Process -Id $env:OLDPID -Timeout 8 -ErrorAction SilentlyContinue } catch {}" >nul 2>&1',
