    ...
    def _write_updater_script(self, target_exe, downloaded_exe, backup_exe):
        try:
            ...
            script_lines = [
                ...
                'if "%START_OK%"=="0" powershell -NoProfile -NonInteractive -ExecutionPolicy Bypass -Command "Start-Process -FilePath $env:TARGET -WorkingDirectory $env:TARGET_DIR" >nul 2>&1',
